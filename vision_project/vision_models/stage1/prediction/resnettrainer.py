...
from vision_models.resnetmodel import ResNetVisionModel, ResNetModelTrainer
class ResNetVisionModelPipeline:
    ...
    def train_model(self, model, train_dataset, val_dataset):
        with self.strategy.scope():
            ...
            trainer = ResNetModelTrainer(model)
...
def main():
    pipeline = ResNetVisionModelPipeline()
